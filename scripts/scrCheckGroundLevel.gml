   ...
   // var InitAngle;   
    ...
    if(AngleMode == 0){ 
      ...
      //  }
        ...
        }else if(TerrainLeft == noone &&(TerrainMiddle != noone || abs((RightX-20)-floor(x)) <= 1) && TerrainRight != noone){
            x = RightX-20;  
        }else if(TerrainRight == noone &&(TerrainMiddle != noone || abs((LeftX-20)-floor(x)) <= 1) && TerrainLeft != noone){           
            x = LeftX-20; 
        }        */
        if(TerrainRight != noone && TerrainLeft != noone && TerrainMiddle != noone){          
            x = min(LeftX, RightX, MiddleX)-20;              
